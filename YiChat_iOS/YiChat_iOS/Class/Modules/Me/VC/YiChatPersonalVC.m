...
- (void)InitialOlderWalletWithState{
    ...
    if(YiChatProject_IsNeedRedPackge){
        iconArr = @[@[@"icon_scan.png"],@[@"me_albumn.png"],@[@"me_dynamic.png"],@[@"me__change.png"],@[@"me_setting.png"],@[@"me_vidiomanage.png"],@[@"me_invite.png"]];
        textArr = @[@[@"扫一扫"],@[@"我的相册"],@[@"好友圈"],@[@"钱包"],@[@"设置"],@[@"视频管理"],@[@"邀请码"]];
    }else{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if([model isKindOfClass:[ProjectCommonCellModel class]]){
        ...
        }else if ([model.titleStr isEqualToString:@"视频管理"]){
            [self pushVCWithName:@"YiChatPersonalCentorListVC"];
        }else if ([model.titleStr isEqualToString:@"邀请码"]){
            [self pushVCWithName:@"YiChatInviteVC"];
//            #import "YiChatShortVC.h" YiChatInviteVC
        }
