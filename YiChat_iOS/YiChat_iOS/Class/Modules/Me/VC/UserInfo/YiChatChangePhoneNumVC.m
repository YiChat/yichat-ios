...
- (void)makeUI{
    if(self.model && [self.model isKindOfClass:[YiChatUserModel class]]){
        ...
        self.inputViews.backgroundColor = PROJECT_COLOR_APPBACKCOLOR;
    }
}
...
- (UIView *)inputViews{
    if(!_inputViews){
        ...
        if(self.type == 0){
            ...
            _inputViews.backgroundColor = PROJECT_COLOR_APPBACKCOLOR;
        }
    }
    return _inputViews;
}
...
- (ProjectTextInputView *)inputPhoneNum{
    if(!_inputPhoneNum){
        ...
        _inputPhoneNum.backgroundColor = PROJECT_COLOR_APPBACKCOLOR;
    }
...
- (ProjectTextInputView *)inputCertify{
    if(!_inputCertify){
        ...
        _inputCertify.backgroundColor =PROJECT_COLOR_APPBACKCOLOR;
    }
...
- (ProjectTextInputView *)inputPassword{
    if(!_inputPassword){
        ...
        _inputPassword.backgroundColor = PROJECT_COLOR_APPBACKCOLOR;
    }
...
- (ProjectTextInputView *)inputPasswordAgain{
    if(!_inputPasswordAgain){
        ...
        _inputPasswordAgain.backgroundColor = PROJECT_COLOR_APPBACKCOLOR;
    }
