...
//    id progress = [ProjectUIHelper ProjectUIHelper_getProgressWithText:@""];
    if (isGroup) {
        [ProjectRequestHelper sendGroupRedPackageWithParameters:param headerParameters:[ProjectRequestParameterModel getTokenParamWithToken:YiChatUserInfo_Token] progress:nil isScrete:YES isAsyn:YES identider:^(NSString * _Nonnull identify) {
...
//                [ProjectRequestHelper progressHidden:progress];
        ...
        [ProjectRequestHelper sendSingleRedPackageWithParameters:param headerParameters:[ProjectRequestParameterModel getTokenParamWithToken:YiChatUserInfo_Token] progress:nil isScrete:YES isAsyn:YES identider:^(NSString * _Nonnull identify) {
