...
+ (id)initialVC{
    YiChatGroupListVC *groupList = [YiChatGroupListVC initialVCWithNavBarStyle:ProjectNavBarStyleCommon_14 centeritem:PROJECT_TEXT_LOCALIZE_NAME(@"savedGroup") leftItem:nil rightItem:[UIImage imageNamed:@"add_new.png"]];
    return groupList;
}
