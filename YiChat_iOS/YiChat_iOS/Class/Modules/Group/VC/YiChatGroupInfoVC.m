...
//        #define YiChatGroupInfoVC_GroupDescribe @"群描述"
     return @[@[YiChatGroupInfoVC_GroupMemberList],@[YiChatGroupInfoVC_GroupID,YiChatGroupInfoVC_GroupName,YiChatGroupInfoVC_GroupAvtor,YiChatGroupInfoVC_GroupDes],@[YiChatGroupInfoVC_GroupMsgClose,YiChatGroupInfoVC_GroupSilence],@[YiChatGroupInfoVC_GroupManagerList],@[YiChatGroupInfoVC_GroupShutUpPersonList,YiChatGroupInfoVC_DeleteGroupMsg]];
    }
    else{
        //YiChatGroupInfoVC_GroupDes
         return @[@[YiChatGroupInfoVC_GroupMemberList],@[YiChatGroupInfoVC_GroupID,YiChatGroupInfoVC_GroupName,YiChatGroupInfoVC_GroupAvtor,YiChatGroupInfoVC_GroupDes],@[YiChatGroupInfoVC_GroupMsgClose,YiChatGroupInfoVC_DeleteGroupMsg]];
    }
}
...
- (YiChatGroupMemberListView *)groupMemberListView{
    if(!_groupMemberListView){
        ...
        _groupMemberListView.YiChatGroupMemberInfo = ^YiChatGroupInfoModel * _Nonnull{
            return weakSelf.groupInfoModel;
        };
