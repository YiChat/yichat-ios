...
static  NSString * const tradeNoKey = @"tradeNo";//recommendCode
static  NSString * const recommendCodeKey = @"recommendCode";//recommendCode
...
+ (NSDictionary *)getTokenParamWithToken:(NSString *)token page:(NSString *)page pageSize:(NSString *)pageSize{
    NSMutableDictionary *dic = [NSMutableDictionary dictionaryWithCapacity:0];
    
    [self addEntityWithObj:page key:pageNoKey dic:dic];
...
+ (NSDictionary *)getRegisterParametersWithMobile:(NSString *)mobile
                                         ...
                                         platform:(NSString *)platform recommendCode:(NSString *)recommendCode{
    NSMutableDictionary *dic = [NSMutableDictionary dictionaryWithCapacity:0];
    ...
    [self addEntityWithObj:recommendCode key:recommendCodeKey dic:dic];
    [self addEntityWithObj:[ProjectHelper helper_getDeviceId] key:deviceIdKey dic:dic];
    return dic;
}
