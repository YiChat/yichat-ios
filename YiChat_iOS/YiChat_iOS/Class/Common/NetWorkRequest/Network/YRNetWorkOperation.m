...
//    if([interface isEqualToString:@"/api/video/publish"] || [interface isEqualToString:@"/api/video/list"] || [interface isEqualToString:@"/api/video/praise"] || [interface isEqualToString:@"/api/video/comment/list"] || [interface isEqualToString:@"/api/video/comment/praise"] || [interface isEqualToString:@"/api/video/comment"]){
//
//        baseURL = @"http://im.yichatsystem.com:8021";
//    }
