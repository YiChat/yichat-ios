...
+ (void)userDepositItem:(NSDictionary *)parameters
      headerParameters:(NSDictionary *)headerParameters
              progress:(id)progress
              isScrete:(BOOL)screteState
                isAsyn:(BOOL)isAsyn
         ...
         successHandle:(RequestHelperRequestSuccessHandle)sucess
                  fail:(RequestHelperRequestFailHandle)fail{
    [self requestHelper_httpRequestWithInterface:@"/api/user/deposit/item" parameters:parameters headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}
...
+ (void)userOnlineRecordWithParameters:(NSDictionary *)parameters
                   headerParameters:(NSDictionary *)headerParameters
                           progress:(id)progress
                           isScrete:(BOOL)screteState
                             isAsyn:(BOOL)isAsyn
                      ...
                      successHandle:(RequestHelperRequestSuccessHandle)sucess
                               fail:(RequestHelperRequestFailHandle)fail{
    [self requestHelper_httpRequestWithInterface:@"/api/user/online/record" parameters:parameters headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}
...
+ (void)userRecommendListWithParameters:(NSDictionary *)parameters
                   headerParameters:(NSDictionary *)headerParameters
                           progress:(id)progress
                           isScrete:(BOOL)screteState
                             isAsyn:(BOOL)isAsyn
                      ...
                      successHandle:(RequestHelperRequestSuccessHandle)sucess
                               fail:(RequestHelperRequestFailHandle)fail{
    [self requestHelper_httpRequestWithInterface:@"/api/user/recommend/list" parameters:parameters headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}

+ (void)configLinkWithParameters:(NSDictionary *)parameters
                   headerParameters:(NSDictionary *)headerParameters
                           progress:(id)progress
                           isScrete:(BOOL)screteState
                             isAsyn:(BOOL)isAsyn
                      ...
                      successHandle:(RequestHelperRequestSuccessHandle)sucess
                               fail:(RequestHelperRequestFailHandle)fail{
    [self requestHelper_httpRequestWithInterface:@"/api/config/link" parameters:parameters headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}
...
+ (void)getShortVideoHeaderParameters:(NSDictionary *)headerParameters type:(NSString *)type
     progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
                                 fail:(RequestHelperRequestFailHandle)fail{
    [self requestHelper_httpRequestWithInterface:@"/api/video/list" parameters:@{@"type" : type} headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}

//+ (void)getShortVideoHeaderParameters:(NSDictionary *)headerParameters
//     progress:(id)progress
//     isScrete:(BOOL)screteState
//       isAsyn:(BOOL)isAsyn
//    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
...
//                                 fail:(RequestHelperRequestFailHandle)fail{
//
//    [self requestHelper_httpRequestWithInterface:@"/api/video/list" parameters:@{} headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
//}

+ (void)getMyListHeaderParameters:(NSDictionary *)headerParameters type:(NSString *)type
     progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    NSMutableDictionary *param = [[NSMutableDictionary alloc]initWithDictionary:headerParameters copyItems:YES];
    [self addEntityWithObj:type key:@"type" dic:param];
    [self requestHelper_httpRequestWithInterface:@"/api/video/my/list" parameters:param headerParameters:dic requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}

+ (void)sendShortVideoWithPath:(NSString *)path thumbnail:(NSString *)thumbnail seconds:(NSInteger)second rate:(CGFloat)rate content:(NSString *)content headerParameters:(NSDictionary *)headerParameters
     progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    [self addEntityWithObj:path key:@"path" dic:param];
//    [self addEntityWithObj:thumbnail key:@"thumbnail" dic:param];
    [self addEntityWithObj:[NSNumber numberWithInteger:second] key:@"seconds" dic:param];
    [self addEntityWithObj:content key:@"content" dic:param];
    [self addEntityWithObj:[NSNumber numberWithFloat:rate] key:@"rate" dic:param];
    
      [self requestHelper_httpRequestWithInterface:@"/api/video/publish" parameters:param headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}


+ (void)praiseShortVideoWithVideoId:(NSInteger)videoId headerParameters:(NSDictionary *)headerParameters
     progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    [self addEntityWithObj:[NSNumber numberWithInteger:videoId] key:@"videoId" dic:param];
       
       
    [self requestHelper_httpRequestWithInterface:@"/api/video/praise" parameters:param headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}

+ (void)videoRewardMemoWithHeaderParameters:(NSDictionary *)headerParameters
     progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
                               fail:(RequestHelperRequestFailHandle)fail{
    [self requestHelper_httpRequestWithInterface:@"/api/video/reward/memo" parameters:@{} headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}

+ (void)shortVideoCommitListVideoId:(NSInteger)videoId pageNo:(NSInteger)pageNo pageSize:(NSInteger)pageSize   headerParameters:(NSDictionary *)headerParameters     progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    NSMutableDictionary *param = [NSMutableDictionary dictionaryWithCapacity:0];
       [self addEntityWithObj:[NSNumber numberWithInteger:videoId] key:@"videoId" dic:param];
        [self addEntityWithObj:[NSNumber numberWithInteger:pageNo] key:@"pageNo" dic:param];
     [self addEntityWithObj:[NSNumber numberWithInteger:pageSize] key:@"pageSize" dic:param];
       
         [self requestHelper_httpRequestWithInterface:@"/api/video/comment/list" parameters:param headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}

+ (void)shortVideoCommitVideoId:(NSInteger)videoId content:(NSString *)content commentId:(NSInteger)commentId srcCommentId:(NSInteger)srcCommentId  headerParameters:(NSDictionary *)headerParameters
                       progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    //评论子id
    if(commentId != 0){
           [self addEntityWithObj:[NSNumber numberWithInteger:commentId] key:@"commentId" dic:param];
    }
    //视频评论列表id
    if(srcCommentId != 0){
        [self addEntityWithObj:[NSNumber numberWithInteger:srcCommentId] key:@"srcCommentId" dic:param];
    }
    [self addEntityWithObj:content key:@"content" dic:param];
    [self requestHelper_httpRequestWithInterface:@"/api/video/comment" parameters:param headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}


+ (void)shortVideoCommitPraiseWithcommentId:(NSInteger)commentId  headerParameters:(NSDictionary *)headerParameters progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    NSMutableDictionary *param = [NSMutableDictionary dictionaryWithCapacity:0];
             [self addEntityWithObj:[NSNumber numberWithInteger:commentId] key:@"commentId" dic:param];
              ...
              [self requestHelper_httpRequestWithInterface:@"/api/video/comment/praise" parameters:param headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}

+ (void)shortVideoCommitDeleteWithcommentId:(NSInteger)commentId  headerParameters:(NSDictionary *)headerParameters progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    NSMutableDictionary *param = [NSMutableDictionary dictionaryWithCapacity:0];
             [self addEntityWithObj:[NSNumber numberWithInteger:commentId] key:@"commentId" dic:param];
              ...
              [self requestHelper_httpRequestWithInterface:@"/api/video/comment/delete" parameters:param headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}


+ (void)shortvideoCommitReplyListWithcommentId:(NSInteger)commentId  pageNo:(NSInteger)pageNo pageSize:(NSInteger)pageSize   headerParameters:(NSDictionary *)headerParameters progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    [self requestHelper_httpRequestWithInterface:@"/api/video/comment/reply/list" parameters:param headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}


+ (void)playVideoWithVideoId:(NSInteger)videoId headerParameters:(NSDictionary *)headerParameters progress:(id)progress
     isScrete:(BOOL)screteState
       isAsyn:(BOOL)isAsyn
    identider:(RequestHelperRequestGetRequestIdentify)identifierBlock
successHandle:(RequestHelperRequestSuccessHandle)sucess
    ...
    NSMutableDictionary *param = [NSMutableDictionary dictionaryWithCapacity:0];
       ...
       [self requestHelper_httpRequestWithInterface:@"/api/video/play" parameters:param headerParameters:headerParameters requestMethod:YRNetWorkRequestMethodPost progress:progress progressIsAutoHidden:YES isScrete:screteState isAsyn:isAsyn identider:identifierBlock successHandle:sucess fail:fail];
}
