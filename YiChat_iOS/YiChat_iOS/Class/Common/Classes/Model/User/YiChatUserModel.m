...
-(NSString *)ucodeStr{
    YiChatUserModel *model = self;
    if(model && [model isKindOfClass:[YiChatUserModel class]]){
        if(model.ucode && [model.ucode isKindOfClass:[NSString class]]){
            return model.ucode;
        }
    }
    return @"";
...
-(NSString *)recommendCountStr{
    YiChatUserModel *model = self;
    if(model && [model isKindOfClass:[YiChatUserModel class]]){
        if(model.recommendCount && [model.recommendCount isKindOfClass:[NSString class]]){
            return model.recommendCount;
        }
    }
    return @"";
}

-(NSString *)recommendCodeStr{
    YiChatUserModel *model = self;
    if(model && [model isKindOfClass:[YiChatUserModel class]]){
        if(model.recommendCode && [model.recommendCode isKindOfClass:[NSString class]]){
            return model.recommendCode;
        }
    }
    return @"";
}
