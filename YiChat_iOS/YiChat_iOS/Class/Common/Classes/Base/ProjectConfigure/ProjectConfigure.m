...
- (UITabBarController *)getTabBarVC{
    ...
    NSArray *textArr = @[PROJECT_TEXT_LOCALIZE_NAME(@"conversationMain"),PROJECT_TEXT_LOCALIZE_NAME(@"connectionMain"),@"YiChat",PROJECT_TEXT_LOCALIZE_NAME(@"meMain")];
       NSArray *classNameArr = @[@"YiChatConversationVC",@"YiChatConnectionVC",@"ConfigLinkController",@"YiChatShortVC",@"YiChatPersonalVC"];
       NSArray *lightIconArr = @[@"news@3x.png",@"contacts@3x.png",@"find@3x.png",@"we@3x.png"];
       NSArray *darkIconArr = @[@"news_n@3x.png",@"contacts_n@3x.png",@"find_n@3x.png",@"we_n@3x.png"];
