...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Bugly startWithAppId:@"8b813002f0" config:config];
    ...
    [[YiChatServiceClient defaultChatClient] yiChatServiceClient_AutoLogin:^(BOOL isSuccess) {
        if(isSuccess == NO){
            [ProjectHelper helper_getMainThread:^{
                YiChatLoginVC *login = (YiChatLoginVC *)[[ProjectConfigure defaultConfigure] getAppAppearLoginVC];
...
-(void)setJGPush:(NSDictionary *)launchOptions{
    ...
    [JPUSHService setupWithOption:launchOptions appKey:YiChatProject_JGPUSH_AppKey channel:@"channel" apsForProduction:YES advertisingIdentifier:nil];
